...
<button
	id="resize"
	class="flex h-full cursor-nwse-resize items-center justify-center overflow-hidden p-2 text-figma-color-text hover:text-figma-color-text-hover active:text-figma-color-text-hover origin-bottom-right motion-safe:transition-transform"
	on:mousedown={() => {
		resizing = true;
